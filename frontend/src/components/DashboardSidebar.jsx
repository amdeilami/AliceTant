...
const DashboardSidebar = ({ role, activeSection, onNavigate, isOpen, onClose }) => {
    ...
    const adminNavItems = [
        ...
        },
        {
            ...
            icon: (
                <svg className="w-5 h-5" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M17 20h5V9l-10-7L2 9v11h5m10 0v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6m10 0H7" />
                </svg>
            ),
        },
        {
        ...
        },
        {
            ...
            icon: (
                <svg className="w-5 h-5" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M11 3v18m-4-8v8m8-14v14m4-10v10" />
                </svg>
            ),
        },
        {
    ...
    return (
        <>
            ...
            <aside
                ...
                `}
                aria-label={`${role === 'customer' ? 'Customer' : role === 'provider' ? 'Provider' : 'Admin'} dashboard navigation`}
                role="navigation"
            >
